...
PYTHONIOENCODING=utf-8 .venv/Scripts/python.exe src/market_vs_corr.py    # 検証：無分別度 vs 相関平均
PYTHONIOENCODING=utf-8 .venv/Scripts/python.exe src/asean_finance.py     # ASEAN金融×無分別（ドメイン展開）
```
